    ...
    def run(self, dataset: Dataset, add_data: List[Dataset], mix_datasets: bool=True, single_d: str="test") -> List[Dict[str, Dict[str, List[float]]]]:
        ...
        for r_outer in range(self.n_repeats_outer):
            ...
            for s_outer, (train_val_indices, test_indices) in enumerate(
                    ...
                    for i, sub_cfg in enumerate(permutations_dicts):
                        ...
                        for r_inner in range(self.n_repeats_inner):
                            ...
                            for s_inner, (
                                ...
                                # training metrics.
                                train_metrics, train_losses, val_metrics, val_losses, _, _ = trainer.train(
                ...
                print("Trainer in features", trainer_cfg.model.in_features)
                ...
                use_rrt = trainer.use_rrt
                print("Use rrt?", use_rrt)
        ...
        if "cindex" in cv_train_val_metrics.keys():
            print("Consider c-index results")
            return cv_train_val_metrics["cindex"], cv_test_metrics["cindex"]
        else:
            print("Keys", cv_train_val_metrics.keys())
            print("Consider accuracy")
            return cv_train_val_metrics["accuracy"], cv_test_metrics["accuracy"]
